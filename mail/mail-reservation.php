<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $mail_to = "hello@masihisathi.com";
        
        # Sender Data
        //$subject = trim($_POST["subject"]);
		$subject = "New Reservation - Wedding matrimony";
        ...
        # Send the email.
        $success = mail($mail_to, $subject, $cform, $headers);
        if ($success) {
            # Set a 200 (okay) response code.
            http_response_code(200);
            echo "Thank You! you successfully reserved.";
        } else {
